<?php
    ...
    $sort = "chrono asc"; // Force chronological sort
...
<html>
    <head>
        ...
        <script type="text/javascript">
            function switchCheckbox(id, chrono) {
                var hiddenId = "c" + chrono;
                var box = document.getElementById(id); // Get checkbox
                var hiddenBox = document.getElementById(hiddenId); //Get hidden checkbox
                hiddenBox.click();
                box.click();
            };
            function cancel() {
    ...
    <body>
        ...
        <!--Page Wide Form-->
            <form method="get" name="order" action="reorder-select-locater.php">
                <!--Anchored Top Menu Bar-->
                    <div class="anchoredbox">
                        ...
                        <p class="desc"><span class="textreg">Select all the photos you would like to move. Click a photo to check it.</span><br></p>
                        <hr size="1">
...
<?php
    ...
    { 
        ...
        echo "<input type=\"checkbox\" id=\"$id\" name=\"idsToReorder[]\" value=\"$id\">";
        echo "<input type=\"checkbox\" id=\"c$chrono\" name=\"chronosToReorder[]\" value=\"$chrono\" class=\"hidden\"><br>";
        echo "<a href=\"javascript:void(0)\" onclick=\"switchCheckbox($id, $chrono);\"><img align=\"center\" width=\"" . $width . "\" height=\"" . $height . "\" src=\"images/thumbnails/" . $name . "\" title=\"" . $title . "\" border=\"0\"></a>";
        echo "\n";
        echo "<br>\n";
        echo "</div>\n\n";
    }
