<?php
    ...
    // Initialize order to sort pictures
    if (isset($_SESSION["sortAssign"]))
        $sort = $_SESSION["sortAssign"];
    else
    {
        $sort = "chrono asc";
        $_SESSION["sortAssign"] = "chrono asc";
    }

    $_SESSION["returnUrl"] = "index.php";
    $_SESSION["searchSQL"] = ""; // Clear WHERE clause of sql query addded by search-results.php
    ...
    <body>
        ...
        <!--Header-->
            <span class="textbg nohref">
                <a href="index.php"><u><b>Example Vote Site</b></u></a>
                <br><br><br>
            </span>
                ...
                <!--Sort Order-->
                    ...
                    <form method="get" name="sort" action="sort.php">
                        <select name="sortselect" id="sortselect">
                         ...
                         <input type="text" name="returnUrl" value="index.php" class="hidden"/>
...
<?php
    // $_SESSION["sortAssign"] is string to be inserted into mysql query
    // Updates the sort select form in menu
    // Default is chrononological
    ...
    $result = mysqli_query($db_connect, "SELECT * FROM `examplephotos` ORDER BY $sort") or die (mysqli_error());
